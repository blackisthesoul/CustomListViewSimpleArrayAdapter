package com.godzealous.customlistviewdengansimplearrayadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NameList= getResources().getStringArray(R.array.sports_array);
        ...
        lv.setAdapter(new CustomAdapter(this, NameList,Images));
    }
